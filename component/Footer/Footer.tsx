...
const ABOUT_US_LINKS: FooterLink[] = [
  ...
  { href: '/eu-docs', label: 'EU Compliances Docs' },
];

const QUICK_LINKS: FooterLink[] = [
  { href: '/orders', label: 'Orders & Shipping' },
  { href: '/seller-login', label: 'Join/Login as a Seller' },
...
const PaymentIcons = [
  ...
  { src: '/cards/ipay.svg', alt: 'Apple Pay' }, 
        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.contact}>
            ...
            <p className={styles.contactInfo}>
              <a href="mailto:customercare@mettarmuse.com" className={styles.contactLink}>
                customercare@mettarmuse.com
              </a>
            </p>
          ...
          <div className={styles.followAcceptColumn}>
            <div className={styles.followUs}>
              ...
              <div className={styles.socialIcons}>
                {/* Instagram Icon (Placeholder SVG) */}
                <a href="https://instagram.com" aria-label="Follow us on Instagram" className={styles.socialIcon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                {/* LinkedIn Icon (Placeholder SVG) */}
                <a href="https://linkedin.com" aria-label="Connect with us on LinkedIn" className={styles.socialIcon}>
            ...
            <div className={styles.accepts}>
              <h4 className={styles.linkTitle}>mettā muse ACCEPTS</h4>
              <div className={styles.paymentIcons}>
                {PaymentIcons.map((icon) => (
                  <div key={icon.alt} className={styles.paymentIconWrapper}>
                    <Image
                      src={icon.src}
                      alt={icon.alt}
                      unoptimized 
                      width={55} // Finalized size for fitting on one line
                      height={32} // Finalized size for fitting on one line
